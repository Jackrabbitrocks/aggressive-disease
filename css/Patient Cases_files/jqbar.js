        ...
        jqbar: function (options) {
            ...
            return this.each(function () {
                ...
                function animateProgressBar(progressBar) {
                    ...
                    var level = progressBar.attr('data-value');//don't round - removed parseInt func
                    ...
                    if (settings.orientation == 'h') {
                        progressBar.animate({ width: w }, {
                            ...
                            step: function (currentWidth) {
                                var percent = currentWidth / settings.barLength * 100;
                                percent = percent.toFixed(1);//modify the percentage to accept single decimal point
                                if (isNaN(percent))
                                    percent = 0;
                                progressContainer.find('.bar-percent').html(percent);//REMOVED THE % PER PSD
                            }
                        });
                    }
                    else {
